  ...
  return (
    <div>
      ...
      <Typography variant="body1">
        ...
        regulations
        , and agree that you are responsible for compliance with any applicable local laws. If
      ...
      <ol type="a">
        <li>
          <Typography variant="body1">
            ...
            software) on
            Coindrop&lsquo;s website for personal, non-commercial transitory viewing only. This is
            the
            grant of a
          ...
          <ol type="i">
            <Typography variant="body1">
              ...
              <li>
                attempt to decompile or reverse engineer any software contained on Coindrop&lsquo;s
                website;
              </li>
        ...
        <Typography variant="body1">
          <li>
            ...
            may be
            terminated by Coindrop at any time. Upon terminating your viewing of these materials or
            upon the
      ...
      <ol type="a">
        <Typography variant="body1">
          <li>
            The materials on Coindrop&lsquo;s website are provided on an &lsquo;s is&lsquo; basis.
            Coindrop makes no
            warranties,
          ...
          <li>
            Further, Coindrop does not warrant or make any representations concerning the accuracy,
            likely
      ...
      <Typography variant="body1">
        In no event shall Coindrop or its suppliers be liable for any damages
        (including, without limitation,
        damages for loss of data or profit, or due to business interruption) arising out of the use
        or inability
        to use the materials on Coindrop&lsquo;s website, even if Coindrop or a Coindrop authorized
        representative has
      ...
      <Typography variant="body1">
        The materials appearing on Coindrop&lsquo;s website could include technical,
        typographical, or photographic
        errors. Coindrop does not warrant that any of the materials on its website are accurate,
        complete or
        current. Coindrop may make changes to the materials contained on its website at any time
        without notice.
      ...
      <Typography variant="body1">
        Coindrop has not reviewed all of the sites linked to its website and is not
        responsible for the contents
        of any such linked site. The inclusion of any link does not imply endorsement by Coindrop of
        the site.
        Use of any such linked website is at the user&lsquo;s own risk.
      </Typography>
      <br />

      <Typography variant="h5">7. Modifications</Typography>
      <Typography variant="body1">
        Coindrop may revise these terms of service for its website at any time without
      ...
      <Typography variant="body1">
        Your privacy is important to us. It is Coindrop&lsquo;s policy to respect your privacy
        regarding any
      ...
      <Typography variant="body1">
        ...
        What data we store, we’ll protect within commercially acceptable means to prevent loss and
        theft, as
